 ...
 */ async function main() {
    ...
    if (!(canvas instanceof HTMLCanvasElement)) throw new Error(`Expected HTMLCanvasElement, recieved ${canvas}`);
    ...
    if (!device) throw new Error("No appropriate GPUDevice foujnd.");
    const context = canvas.getContext("webgpu");
    if (!context) throw new Error("Failed to get webgpu context from canvas element");
